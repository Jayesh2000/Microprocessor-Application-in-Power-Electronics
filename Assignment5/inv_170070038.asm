...
input	.float	0.5	; 
result	.float	0.0	; \result=1/(1-x) for 5 terms approximation result returned by the CLA
...
cstatus	.word	0xffff		; Bit-0 indicates CLA program completion
	...
	MADDF32	MR2, MR1, #1.0			;MR2 = 1+x
	MMPYF32	MR1, MR0, MR1			;MR1 = x^2
	MADDF32	MR2, MR1, MR2			;MR2 = 1 + x + (x^2)
	MMPYF32	MR1, MR0, MR1			;MR1 = x^3
	MADDF32	MR2, MR1, MR2			;MR2 = 1 + x + (x^2) + (x^3)
	MMPYF32	MR1, MR0, MR1			;MR1 = x^4
	MADDF32	MR2, MR1, MR2			;MR2 = 1 + x + (x^2) + (x^3) + (x^4)
